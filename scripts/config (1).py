...
BRAND = "ZMAFIT"
SITE = "zmafit.com"
# لغة الفيديو: ar (الافتراضي، قناة Muscle Arabia) أو en (تيك توك الإنجليزي)
LANG = os.environ.get("VIDEO_LANG", "ar").strip().lower() or "ar"
CHANNEL_LANG = LANG
...
# أصوات إنجليزية مقترحة: en-US-AndrewNeural (رجالي حماسي) | en-US-GuyNeural | en-US-AriaNeural (نسائي)
_DEFAULT_VOICE = "en-US-AndrewNeural" if LANG == "en" else "ar-EG-ShakirNeural"
